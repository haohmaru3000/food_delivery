...
// Lấy số bự đã dc shift qui đổi ngược xuống
...
// Do uid sau khi shift vẫn là số int, dùng base58 để encode -> ko thể đọc dc
func FromBase58(s string) (UID, error) {
	return DecomposeUID(string(base58.Decode(s))) // mã hóa 2 chiều ko cần key
}
